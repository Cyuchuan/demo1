...
public class Message {
     ...
     *
     * @param byteBuffer
     *            The ByteBuffer containing the message data to write.
     * @return
     */
     ...
     *
     * @param byteArray
     *            The byte array containing the message data to write.
     * @return
     */
     ...
     *
     * @param message
     *            The message containing the partial message (after the first message).
     * @param endIndex
     *            The end index of the first message in the buffer of the message given as parameter.
     */
